...
import { postData, deleteData, getData } from './api.service'
...
export const forgotPassword = async (payload: {
  ...
  try {
    const response = await postData<ForgotPasswordResponse>(
...
export const resetPassword = async (payload: {
  ...
  try {
    const response = await postData<ResetPasswordResponse>(
      '/auth/reset-password',
      payload
    )
