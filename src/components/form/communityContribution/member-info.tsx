    ...
    <Card>
      ...
      <CardFooter>
        <div className='text-red-600 text-xs'>
          *Note: During the case registration process, no changes or modifications to
          personal information, including voter details, Aadhaar card information, etc., will
          be accepted.
          <br />
