...
import { CaseRegistrationFormValues } from '@/schema/communityContributionSchema'
import {
  Card,
  CardContent,
  CardDescription,
                ...
                render={({ field }) => (
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value='Constitutional Cases'>
                        Constitutional Cases
                      </SelectItem>
                      <SelectItem value='Administrative Cases'>
                        Administrative Cases
                      </SelectItem>
                      <SelectItem value='Family Law Cases'>
                        Family Law Cases
                      </SelectItem>
                      <SelectItem value='Commercial Cases'>
                        Commercial Cases
                      </SelectItem>
                      <SelectItem value='Labor and Employment Cases'>
                        Labor and Employment Cases
                      </SelectItem>
                      <SelectItem value='Environmental Cases'>
                        Environmental Cases
                      </SelectItem>
                      <SelectItem value='Property Cases'>
                        Property Cases
                      </SelectItem>
                      <SelectItem value='Consumer Cases'>
                        Consumer Cases
                      </SelectItem>
                    </SelectContent>
                  </Select>
          ...
          <div className='grid grid-cols-1 gap-4'>
            <div>
              ...
              <Input
                ...
                className='block w-full rounded-md border p-2'
              />
              {typeof errors.additionalDocument?.message === 'string' && (
                <span className='text-sm text-destructive'>
          ...
          <div className='grid grid-cols-1 gap-4 md:grid-cols-2'>
            <div>
              ...
              <div className='text-sm text-red-600'>
                Financial Aid Currently unavailable
              </div>
            </div>
          </div>
        </div>
