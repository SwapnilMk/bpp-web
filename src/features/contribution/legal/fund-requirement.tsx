...
export function FundRequirementForm({ onNext, onBack }: FundRequirementFormProps) {
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
        ...
        <PercentageAmountInput form={form} name="familyFriends" label="Family & Friends" />
        <PercentageAmountInput form={form} name="workplace" label="Workplace" />
        <PercentageAmountInput form={form} name="otherInstitutes" label="Other Institutes" />
        <FormField
          control={form.control}
