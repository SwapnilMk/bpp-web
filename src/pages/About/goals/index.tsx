...
import img7 from '@/assets/images/backgrounds/sliders/EMPLOYMENT_ECONOMIC_GROWTH.webp'
import img2 from '@/assets/images/backgrounds/sliders/EQUAL_OPPORTUNITY_AND_GENDER_EQUALITY.webp'
import img4 from '@/assets/images/backgrounds/sliders/GAINST_MUSCLE_AND_MONEY_POWER.webp'
import img3 from '@/assets/images/backgrounds/sliders/GOOD_HEALTH_AND_WELL_BEING.webp'
import img5 from '@/assets/images/backgrounds/sliders/INDIA_UPHOLD_SECULARISM.webp'
import img6 from '@/assets/images/backgrounds/sliders/INDUSTRIAL_DEVELOPMENT_INFRASTRUCTURE.webp'
import img8 from '@/assets/images/backgrounds/sliders/JUSTICE_PEACE_CALM_PROSPERITY.webp'
import img1 from '@/assets/images/backgrounds/sliders/NATIONAL_INTEGRITY.webp'
import img10 from '@/assets/images/backgrounds/sliders/QUALITY_EDUCATION.webp'
import img9 from '@/assets/images/backgrounds/sliders/UPLIFTMENT_OF_FARMERS.webp'
      ...
      <Card className='flex h-[500px] flex-col justify-between overflow-hidden border bg-white transition-all duration-300 hover:bg-gray-50 hover:shadow-lg dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700'>
        ...
        <CardHeader className='space-y-4 pt-6'>
          <div className='flex items-center gap-4'>
            ...
            <h2 className='text-left font-poppins text-xl font-extrabold tracking-tight text-gray-900 dark:text-white'>
              {title}
            </h2>
          </div>
        </CardHeader>
